...
type MockProtocolClient struct {
	Protocol       coreprotocol.Protocol // current version (separated for easier testing)
...
//
//nolint:gocritic
func GetProtocolVersion(p coreprotocol.Protocol) *ProtocolVersion {
	v := &ProtocolVersion{}
	v.VersionReturns(CurrentVersion)
	v.OperationApplierReturns(&stmocks.OperationApplier{})
	v.OperationParserReturns(&stmocks.OperationParser{})
	v.DocumentComposerReturns(&stmocks.DocumentComposer{})
	v.DocumentTransformerReturns(&stmocks.DocumentTransformer{})
	v.DocumentValidatorReturns(&stmocks.DocumentValidator{})
...
func GetDefaultProtocolParameters() coreprotocol.Protocol {
	return coreprotocol.Protocol{
		GenesisTime:                  0,
